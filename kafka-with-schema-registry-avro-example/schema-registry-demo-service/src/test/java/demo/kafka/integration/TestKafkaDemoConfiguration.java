...
public class TestKafkaDemoConfiguration {
    @Bean
    public ConsumerFactory<String, PaymentSent> testConsumerFactory(@Value("${kafkademo.bootstrap-servers}") final String bootstrapServers, @Value("${kafkademo.schema.registry.url}") final String schemaRegistryUrl) {
    ...
    @Bean
    public ProducerFactory<String, SendPayment> testProducerFactory(@Value("${kafkademo.bootstrap-servers}") final String bootstrapServers, @Value("${kafkademo.schema.registry.url}") final String schemaRegistryUrl) {
        final Map<String, Object> config = new HashMap<>();
